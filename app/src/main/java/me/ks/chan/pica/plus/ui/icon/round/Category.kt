...
val Category by lazy {
    materialSymbol(Name, ViewPortSize) {
        ...
        close()
        moveTo(700F, 800F)
        quadTo(742F, 800F, 771F, 771F)
        quadTo(800F, 742F, 800F, 700F)
        quadTo(800F, 658F, 771F, 629F)
        quadTo(742F, 600F, 700F, 600F)
        quadTo(658F, 600F, 629F, 629F)
        quadTo(600F, 658F, 600F, 700F)
        quadTo(600F, 742F, 629F, 771F)
        quadTo(658F, 800F, 700F, 800F)
        close()
        moveTo(200F, 780F)
        lineTo(360F, 780F)
        lineTo(360F, 620F)
